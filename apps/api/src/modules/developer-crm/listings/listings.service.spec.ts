...
describe('ListingsService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should filter listings by propertyType', async () => {
      ...
      await service.findAll(developerId, memberId, role, { propertyType: 'APARTMENT' });
    ...
    it('should filter listings by listingType', async () => {
      ...
      await service.findAll(developerId, memberId, role, { listingType: 'SALE' });
    ...
    it('should filter listings by status', async () => {
      ...
      await service.findAll(developerId, memberId, role, { status: 'ACTIVE' });
  ...
  describe('findOne', () => {
    ...
    it('should return listing by id', async () => {
      ...
      const result = await service.findOne(developerId, memberId, role, propertyId);
    ...
    it('should throw NotFoundException if listing not found', async () => {
      ...
      await expect(
        service.findOne(developerId, memberId, role, propertyId),
  ...
  describe('update', () => {
    ...
    it('should update listing successfully', async () => {
      ...
      const result = await service.update(developerId, memberId, role, propertyId, updateDto as any);
    ...
    it('should throw NotFoundException if listing not found', async () => {
      ...
      await expect(
        service.update(developerId, memberId, role, propertyId, updateDto as any),
      ).rejects.toThrow(NotFoundException);
    });
    ...
    it('should allow admin to update any listing', async () => {
      ...
      const result = await service.update(developerId, memberId, 'ADMIN', propertyId, updateDto as any);
  ...
  describe('delete', () => {
    ...
    it('should delete listing successfully', async () => {
      ...
      const result = await service.delete(developerId, memberId, role, propertyId);
    ...
    it('should throw NotFoundException if listing not found', async () => {
      ...
      await expect(
        service.delete(developerId, memberId, role, propertyId),
      ).rejects.toThrow(NotFoundException);
    });
    ...
    it('should allow admin to delete any listing', async () => {
      ...
      const result = await service.delete(developerId, memberId, 'ADMIN', propertyId);
