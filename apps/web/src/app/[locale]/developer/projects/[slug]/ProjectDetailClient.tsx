...
export default function ProjectDetailClient({ params }: ProjectDetailClientProps) {
  ...
  const tabs = [
    ...
    {
      id: 'units' as const,
      label: `${t('tabs.units')} (${project.totalUnits || 0})`,
      icon: Home
    },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        {/* Units Tab - Redirect to dedicated units page */}
        {activeTab === 'units' && (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 mb-4">
              View and manage all units for this project
            </p>
            <Link
              href={`/developer/projects/${project.slug}/units`}
