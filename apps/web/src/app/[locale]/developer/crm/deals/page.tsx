    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
        <div className="bg-white p-2.5 sm:p-4 rounded-lg shadow">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="text-[11px] sm:text-xs lg:text-sm text-gray-500 truncate">{t('stats.total')}</p>
        ...
        <div className="bg-white p-2.5 sm:p-4 rounded-lg shadow">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="text-[11px] sm:text-xs lg:text-sm text-gray-500 truncate">{t('stats.totalValue')}</p>
              <p className="text-base sm:text-xl lg:text-2xl font-bold text-gray-900">
                {formatCurrency(
        ...
        <div className="bg-white p-2.5 sm:p-4 rounded-lg shadow">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="text-[11px] sm:text-xs lg:text-sm text-gray-500 truncate">{t('stats.viewing')}</p>
              <p className="text-base sm:text-xl lg:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white p-2.5 sm:p-4 rounded-lg shadow">
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <p className="text-[11px] sm:text-xs lg:text-sm text-gray-500 truncate">{t('stats.negotiation')}</p>
              <p className="text-base sm:text-xl lg:text-2xl font-bold text-gray-900">
                    ...
                    >
                      {stageData.deals.map((deal, index) => (
                        <Draggable key={deal.id} draggableId={deal.id} index={index}>
                          {(provided, snapshot) => (
                            <Link href={`/developer/crm/deals/${deal.id}`}>
                              <div
                                ref={provided.innerRef}
